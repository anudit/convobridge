...
class MyDocument extends Document {
    ...
    render() {
        ...
        return (
            <Html lang="en">
                <Head>
                    <meta name='application-name' content='Convo Space' />
                    ...
                    <meta name='twitter:title' content='Convo Space' />
